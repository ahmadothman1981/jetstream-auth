...
<head>
  <meta charset="utf-8">
    ...
    <title>Easy E-Commerce Admin - Log in </title>
            ...
            @csrf
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" name="password" id="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
								...
								<div class="form-group">
									<div class="input-group mb-3 text-white">
										...
										<input type="checkbox" id="password_show" onclick="myFunction()" >
										<label for="password_show">Show Password </label>
