			  ...
			  <div class="row">
				...
				<input type="text" name="name" class="form-control" required="" value="{{ $adminuser->name }}">
							...
							<div class="col-md-6">
								...
								<div class="controls">
				<input type="email" name="email" class="form-control" required="" value="{{ $adminuser->email }}">
							</div>
							</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="controls">
				<input type="text" name="phone" class="form-control" required="" value="{{ $adminuser->phone }}">
							</div>
							</div>
							</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="controls">
										...
										<fieldset>
											<input type="checkbox" id="checkbox_4" name="product" value="1" {{ $adminuser->slider == 1 ? 'checked' : '' }}>
											<label for="checkbox_4">Product</label>
										</fieldset>
										<fieldset>
											<input type="checkbox" id="checkbox_5" name="slider" value="1" {{ $adminuser->brand == 1 ? 'checked' : '' }}>
