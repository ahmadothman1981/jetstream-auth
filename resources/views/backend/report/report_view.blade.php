...
<!-- Content Wrapper. Contains page content -->
	  ...
	  <div class="container-full">
		...
		<section class="content">
		  <div class="row">
			...
			<! Add Search Page-->
				<div class="col-4"><!-- /.Start - 1st COL-4 -->
	...
	<input type="submit" class="btn btn-rounded btn-primary mb-5 " value="Search">
			...
			<div class="col-4"><!-- /.Start- 2nd COL-4 -->
	...
	<input type="submit" class="btn btn-rounded btn-primary mb-5 " value="Search">
			...
			<div class="col-4"><!-- /.Start- 3rd COL-4 -->
			...
			@enderror
						...
						<div class="text-xs-right">
	<input type="submit" class="btn btn-rounded btn-primary mb-5 " value="Seach">
						</div>
					</form>
					</div>
				</div>
