		...
		<div class="box overflow-hidden pull-up">
			<div class="box-body">							
				...
				<div>
					...
					<h3 class="text-white mb-0 font-weight-500">USD {{ $today }} <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
				</div>
			</div>
		</div>
	</div>
	<div class="col-xl-3 col-6">
		<div class="box overflow-hidden pull-up">
			<div class="box-body">							
				...
				<div>
					<p class="text-mute mt-20 mb-0 font-size-16">Month Sale</p>
					<h3 class="text-white mb-0 font-weight-500">USD {{$month  }} <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="box overflow-hidden pull-up">
			<div class="box-body">							
				...
				<div>
					...
					<h3 class="text-white mb-0 font-weight-500">USD {{ $year }} <small class="text-danger"><i class="fa fa-caret-down"></i> -0.5%</small></h3>
				</div>
			</div>
		</div>
	</div>
