...
<div class="col-md-5"><!--2nd START col-md-5-->

                <div class="card">
                    <div class="card-header">
                        <h4>Order Details 
            <span class="text-danger">Invoice: {{$order->invoice_number }}</span></h4>
                    </div><hr><!--end card-header-->
                    <div class="card-body" style="background: #76A9FA;">
                        <table class="table">
                            <tr>
                                <th> Name:</th>
            ...
            <div class="row"><!--start order items row-->
...
<a target="_balnk" href="{{ asset('upload/pdf/'.$file->digital_file) }}">
