        ...
        <div class="card-body">
          <div  class="row" style="margin-left: 30px;margin-top: 20px;">
            ...
            <div class="track">
                ...
                <div class="step "> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">Order  Picked</span> </div>
                ...
                <div class="step active"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">Order  Picked</span> </div>
