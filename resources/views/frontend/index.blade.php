              ...
              <div class="item">
                <div class="blog-post">
                  ...
                  <div class="blog-post-info text-left">
                    <h3 class="name"><a href="{{ route('blog.details',$blog->id) }}">@if(session()->get('Language') == 'Arabic' ) {{$blog->post_title_ar }} @else {{$blog->post_title_en }}
                        @endif</a></h3>

                    <span class="info">{{ $blog->created_at }} </span>

                    <p class="text">@if(session()->get('Language') == 'Arabic' ) {!! Str::limit($blog->post_details_ar,100) !!} @else {!! Str::limit($blog->post_details_en,100) !!}
                      @endif</p>
