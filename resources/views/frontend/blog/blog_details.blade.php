...
<div class="body-content">
	...
	<h1>@if(session()->get('Language') == 'Arabic' ) {{$blogpost->post_title_ar }} @else {{$blogpost->post_title_en }}
 @endif</h1>
	
	<span class="date-time">{{ $blogpost->created_at }}</span>
	<p>@if(session()->get('Language') == 'Arabic' ) {!! $blogpost->post_details_ar !!} @else {!! $blogpost->post_details_en !!}
 @endif</p>
